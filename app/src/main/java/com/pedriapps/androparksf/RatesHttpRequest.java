 ...
 *  Returns an ArrayList<RateInfo> object.
 */
public class RatesHttpRequest extends AsyncTask<String, Void, ArrayList<RateInfo>>{

    private Context context;

    public RatesHttpRequest(Context context){
     ...
     */
    @Override
    protected ArrayList<RateInfo> doInBackground(String... urls) {

        ArrayList<RateInfo> temp = null;
        try {
     ...
     * @return the location object with data filled in by RatesXMLParser.
     * @throws XmlPullParserException
     * @throws IOException
     */
    private ArrayList<RateInfo> loadXmlFromNetwork(String urlString)
            throws XmlPullParserException, IOException {
        InputStream stream = null;
        ArrayList<RateInfo> temp;

        try {
            stream = downloadUrl(urlString);
            temp = RatesXMLParser.parse(stream);
